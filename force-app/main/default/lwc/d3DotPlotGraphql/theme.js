// ABOUTME: Bundle-local color palettes and helpers for the d3DotPlotGraphql standalone bundle.
// ABOUTME: Provides the SLDS-aligned palettes and getColors used to color the dot plot's category dots.
