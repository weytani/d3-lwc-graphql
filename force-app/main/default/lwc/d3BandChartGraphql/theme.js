// ABOUTME: Bundle-local color palettes and helpers for the d3BandChartGraphql standalone bundle.
// ABOUTME: Provides the SLDS-aligned palettes and the single-color getColor used to paint the band.
...
/**
 * Gets a single color from theme by index. The band chart is single-series, so
 * it takes one color from the palette and reuses it for the fill, the upper and
 * lower boundary strokes, and the optional center line.
