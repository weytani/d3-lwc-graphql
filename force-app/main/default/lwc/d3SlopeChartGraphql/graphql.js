// ABOUTME: Bundle-local Salesforce GraphQL (v2) record-query builder and normalizer for the d3SlopeChartGraphql bundle.
 ...
 * Used by both the structured record path and the free-text `graphqlQuery`
 * override, projecting [groupByField, startValueField, endValueField] in each
 * case, so both feed the same slope shaping. When `objectApiName` is omitted or absent
