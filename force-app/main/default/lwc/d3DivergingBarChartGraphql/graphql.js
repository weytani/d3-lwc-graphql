// ABOUTME: Bundle-local Salesforce GraphQL (v2) query builders and normalizers for the d3DivergingBarChartGraphql bundle.
...
/**
 * Normalizes a grouped-aggregate wire result into [{label,value}] for the
 * diverging bar chart. Values may be signed — negative aggregates extend left
 * of the chart's zero baseline.
